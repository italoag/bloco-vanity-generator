# User Story: Salvar Backup Keystore
...
Como **Operador CLI**, eu quero **salvar keystore, password e mnemonic quando aplicável**, para **restaurar a carteira gerada futuramente**. 🟢
