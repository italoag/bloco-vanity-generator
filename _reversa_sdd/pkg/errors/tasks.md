# Módulo pkg/errors, Tarefas de Implementação
...
- [ ] T-01, Implementar o contrato principal de `pkg/errors`.
  - Origem no legado: `pkg/errors/types.go`
  - Critério de pronto: a unit executa o fluxo principal descrito em `design.md`.
  - Confiança: 🟢
- [ ] T-02, Reimplementar `WrapError`.
  - Origem no legado: `pkg/errors/types.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-03, Preservar regras de negócio e lacunas documentadas.
