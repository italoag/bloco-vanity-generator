# Módulo pkg/utils, Tarefas de Implementação
...
- [ ] T-01, Implementar o contrato principal de `pkg/utils`.
  - Origem no legado: `pkg/utils/format.go`
  - Critério de pronto: a unit executa o fluxo principal descrito em `design.md`.
  - Confiança: 🟢
- [ ] T-02, Reimplementar `CalculateDifficulty`.
  - Origem no legado: `pkg/utils/format.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-03, Reimplementar `CalculateProbability`.
  - Origem no legado: `pkg/utils/format.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-04, Reimplementar `CalculateProbability50`.
  - Origem no legado: `pkg/utils/format.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
