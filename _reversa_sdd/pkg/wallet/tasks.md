# Módulo pkg/wallet, Tarefas de Implementação
...
- [ ] T-01, Implementar o contrato principal de `pkg/wallet`.
  - Origem no legado: `pkg/wallet/types.go`
  - Critério de pronto: a unit executa o fluxo principal descrito em `design.md`.
  - Confiança: 🟢
- [ ] T-02, Reimplementar `Validate`.
  - Origem no legado: `pkg/wallet/types.go`
...
- [ ] T-03, Reimplementar `Update`.
  ...
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-04, Reimplementar `LogWallet`.
  - Origem no legado: `pkg/wallet/logger.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
