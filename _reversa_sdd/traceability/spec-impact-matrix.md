...
| Configuração | `internal/config`, `internal/cli`, `cmd/bloco-vgen` | `Config` e subconfigs | BR-031, BR-032 | env vars, flags, validação de conflitos | 🟢 |
...
| BR-031..BR-036 | `cmd/bloco-vgen`, `internal/config`, `internal/cli`, `internal/worker`, `internal/tui` | 🟢 |
