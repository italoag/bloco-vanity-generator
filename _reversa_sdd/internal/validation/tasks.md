# Módulo internal/validation, Tarefas de Implementação
...
- [ ] T-01, Implementar o contrato principal de `internal/validation`.
  - Origem no legado: `internal/validation/strategy.go`
  - Critério de pronto: a unit executa o fluxo principal descrito em `design.md`.
  - Confiança: 🟢
- [ ] T-02, Reimplementar `ValidateWithCriteria`.
  - Origem no legado: `internal/validation/strategy.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-03, Reimplementar `validateCaseInsensitive`.
  - Origem no legado: `internal/validation/strategy.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-04, Preservar regras de negócio e lacunas documentadas.
