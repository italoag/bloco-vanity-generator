# Caso de Uso: Exibir Stats e Benchmark, Tarefas de Implementação
...
- [ ] T-01, Implementar o contrato principal de `internal/tui/exibir-stats-benchmark`.
  - Origem no legado: `internal/tui/manager.go`
  - Critério de pronto: a unit executa o fluxo principal descrito em `design.md`.
  - Confiança: 🟢
- [ ] T-02, Reimplementar `DetectCapabilities`.
  - Origem no legado: `internal/tui/manager.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-03, Reimplementar `Update`.
  - Origem no legado: `internal/tui/progress.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-04, Reimplementar `View`.
  - Origem no legado: `internal/tui/progress.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
