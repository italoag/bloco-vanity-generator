...
A unit `internal/tui` renderiza progresso, estatísticas e benchmark com Bubble Tea/Bubbles/Lip Gloss. A especificação é baseada nos artefatos Archaeologist/Detective/Architect e nos arquivos principais `internal/tui/manager.go`, `internal/tui/progress.go`, `internal/tui/stats.go`, `internal/tui/benchmark.go`, `internal/tui/styles.go`, `internal/tui/logo.go`, `internal/tui/utils.go`. 🟢

## Responsabilidades

- Manter o contrato operacional descrito para `internal/tui` no legado. 🟢
...
|----|-----------|-----------|-------------------|
| RF-01 | Reimplementar a responsabilidade principal da unit `internal/tui`. | Must | Chamadas equivalentes às funções mapeadas em `internal/tui/manager.go`, `internal/tui/progress.go`, `internal/tui/stats.go`, `internal/tui/benchmark.go`, `internal/tui/styles.go`, `internal/tui/logo.go`, `internal/tui/utils.go` produzem resultados compatíveis. 🟢 |
...
```gherkin
Dado uma entrada válida para `internal/tui`
...
Dado que um módulo consumidor depende de `internal/tui`
