# Caso de Uso: Executar Pool Concorrente, Tarefas de Implementação
...
- [ ] T-01, Implementar o contrato principal de `internal/worker/executar-pool-concorrente`.
  - Origem no legado: `internal/worker/pool.go`
  - Critério de pronto: a unit executa o fluxo principal descrito em `design.md`.
  - Confiança: 🟢
- [ ] T-02, Reimplementar `NewPoolWithConfig`.
  - Origem no legado: `internal/worker/pool.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-03, Reimplementar `GenerateWalletWithContext`.
  - Origem no legado: `internal/worker/pool.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-04, Reimplementar `Start`.
  - Origem no legado: `internal/worker/stats.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-05, Reimplementar `GetPerformanceMetrics`.
  - Origem no legado: `internal/worker/stats.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-06, Preservar regras de negócio e lacunas documentadas.
