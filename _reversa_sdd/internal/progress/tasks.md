# Módulo internal/progress, Tarefas de Implementação
...
- [ ] T-01, Implementar o contrato principal de `internal/progress`.
  - Origem no legado: `internal/progress/manager.go`
  - Critério de pronto: a unit executa o fluxo principal descrito em `design.md`.
  - Confiança: 🟢
- [ ] T-02, Reimplementar `Start`.
  - Origem no legado: `internal/progress/manager.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-03, Reimplementar `Stop`.
  - Origem no legado: `internal/progress/manager.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-04, Reimplementar `aggregateWorkerData`.
  - Origem no legado: `internal/progress/manager.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
