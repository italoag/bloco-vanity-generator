# Caso de Uso: Carregar Configuração, Tarefas de Implementação
...
- [ ] T-01, Implementar o contrato principal de `internal/config/carregar-configuracao`.
  - Origem no legado: `internal/config/config.go`
  - Critério de pronto: a unit executa o fluxo principal descrito em `design.md`.
  - Confiança: 🟢
- [ ] T-02, Reimplementar `DefaultConfig`.
  - Origem no legado: `internal/config/config.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-03, Reimplementar `LoadFromEnvironment`.
  - Origem no legado: `internal/config/config.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
- [ ] T-04, Reimplementar `Validate`.
  - Origem no legado: `internal/config/config.go`
  - Critério de pronto: assinatura, entradas, retornos e erros seguem o comportamento mapeado.
  - Confiança: 🟢
