# Caso de Uso: Gerar Carteira Multirede
...
A unit `internal/crypto/gerar-carteira-multirede` gera carteiras Ethereum, Bitcoin e Solana com interfaces específicas por rede. A especificação é baseada nos artefatos Archaeologist/Detective/Architect e nos arquivos principais `internal/crypto/ethereum.go`, `internal/crypto/bitcoin.go`, `internal/crypto/solana.go`, `internal/crypto/checksum.go`, `internal/crypto/keystore.go`, `internal/crypto/password.go`, `internal/crypto/pools.go`, `internal/crypto/random.go`, `internal/crypto/validation.go`, `internal/crypto/generator.go`. 🟢

## Responsabilidades

- Manter o contrato operacional descrito para `internal/crypto/gerar-carteira-multirede` no legado. 🟢
...
- Por decisão humana, padrões vanity devem ser validados por rede: Ethereum hexadecimal/EIP-55, Bitcoin Base58/bech32 quando aplicável e Solana Base58. 🟢

## Requisitos Funcionais

| ID | Requisito | Prioridade | Critério de Aceite |
|----|-----------|-----------|-------------------|
| RF-01 | Reimplementar a responsabilidade principal da unit `internal/crypto/gerar-carteira-multirede`. | Must | Chamadas equivalentes às funções mapeadas em `internal/crypto/ethereum.go`, `internal/crypto/bitcoin.go`, `internal/crypto/solana.go`, `internal/crypto/checksum.go`, `internal/crypto/keystore.go`, `internal/crypto/password.go`, `internal/crypto/pools.go`, `internal/crypto/random.go`, `internal/crypto/validation.go`, `internal/crypto/generator.go` produzem resultados compatíveis. 🟢 |
...
```gherkin
Dado uma entrada válida para `internal/crypto/gerar-carteira-multirede`
...
Dado que um módulo consumidor depende de `internal/crypto/gerar-carteira-multirede`
