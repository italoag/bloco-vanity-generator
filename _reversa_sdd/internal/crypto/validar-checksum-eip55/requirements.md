# Caso de Uso: Validar Checksum EIP-55
...
A unit `internal/crypto/validar-checksum-eip55` calcula e valida checksum EIP-55 para endereços Ethereum. A especificação é baseada nos artefatos Archaeologist/Detective/Architect e nos arquivos principais `internal/crypto/ethereum.go`, `internal/crypto/bitcoin.go`, `internal/crypto/solana.go`, `internal/crypto/checksum.go`, `internal/crypto/keystore.go`, `internal/crypto/password.go`, `internal/crypto/pools.go`, `internal/crypto/random.go`, `internal/crypto/validation.go`, `internal/crypto/generator.go`. 🟢

## Responsabilidades

- Manter o contrato operacional descrito para `internal/crypto/validar-checksum-eip55` no legado. 🟢
...
|----|-----------|-----------|-------------------|
| RF-01 | Reimplementar a responsabilidade principal da unit `internal/crypto/validar-checksum-eip55`. | Must | Chamadas equivalentes às funções mapeadas em `internal/crypto/ethereum.go`, `internal/crypto/bitcoin.go`, `internal/crypto/solana.go`, `internal/crypto/checksum.go`, `internal/crypto/keystore.go`, `internal/crypto/password.go`, `internal/crypto/pools.go`, `internal/crypto/random.go`, `internal/crypto/validation.go`, `internal/crypto/generator.go` produzem resultados compatíveis. 🟢 |
...
```gherkin
Dado uma entrada válida para `internal/crypto/validar-checksum-eip55`
...
Dado que um módulo consumidor depende de `internal/crypto/validar-checksum-eip55`
